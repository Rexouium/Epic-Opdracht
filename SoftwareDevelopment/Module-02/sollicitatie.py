...
if Hoe_lang_bent_u > 220:
    raise ValueError('U gaat niet door de deur passes')
Hoe_zwaar_bent_u = int(input("Hoe zwaar bent u"))
if Hoe_zwaar_bent_u > 150:
    raise NameError('Ga eens sporten inplaats van eten')
...
Gender = input("Man of Vrouw?").lower()
if Gender == "man":
    ...
    if Haar_kleur == "groen":
        raise NameError("Sorry maar groen? realy?")
